...
`pi-slopchop-jj` is a Pi coding-agent extension that adds the `/jj:diff` terminal review UI. It lets users review diffs, annotate lines/files/whole changes, and insert a follow-up prompt back into Pi.
